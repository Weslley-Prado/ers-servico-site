    ...
    return (
      <sectio className="Formulario">
        ...
        <div className="Form">
          ...
          <div class="row">
            <div class="col mapa">
              <a className="mapaA" href="https://goo.gl/maps/BADxR7VPpsudsaKN9">
                <img class="map" src={Mapa} alt="Politica" />
              </a>
            </div>
            <div class="col left0 contactP">
              ...
              <h3>Localização</h3>
              <p className="lead">
              Rua: Padre João, 444 - 1 Andar - Sala 11 - São Paulo - SP / <br /> Bairro
                Penha de França  CEP: 03637-000
              </p>
            </div>
          </div>
